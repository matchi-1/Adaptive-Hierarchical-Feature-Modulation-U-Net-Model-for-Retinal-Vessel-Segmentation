...
from src.models.blocks.res2net50 import Res2Net
...
class HybridUNetMDFI(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        assert hasattr(backbone, "out_channels") and len(backbone.out_channels) == 4, \
            "Backbone must expose .out_channels with 4 entries."
